...
class Listener(streaming.StreamListener):
    """Responsible for pushing data into a queue
    """
...
class TwitterFeed(observer.Subject):
    ...
    def __init__(self, consumerKey: str, consumerSecret: str, accessToken: str, 
        accessTokenSecret, track: list=None, follow: list=None, languages: list=None
    ):
        track = track or []
        follow = follow or []
